          ...
          <main>
            <article className="article-content">
              ...
              <div className="left">
                ...
                <div className="chapter">
                  <p>
                    Bald ist es wieder so weit. Es gibt wieder SMS-CB am
                    Warntag. Wir zeigen verschiedene Wege, diese nochmal
                    einzusehen.
                  </p>
                </div>
                ...
                <div className="chapter">
                  <p>
                    ...
                    Access erscheinen – stattdessen stampft Publisher Paradox
                    die Entwicklung ein.
                  </p>
                  <p>
                    Der geplante "Sims"-Konkurrent "Life by You" wird nicht
                    fertig entwickelt. Das hat der schwedische Publisher Paradox
                    Interactive am Montagabend bekannt gegeben. Trotz mehrfacher
                    Verschiebungen habe die Entwicklung keine großen
                    Fortschritte gemacht, schreibt Paradox-Manager Mattias Lilja
                    in einem Foren-Eintrag.
                  </p>
                  <p>
                    Erst kürzlich hätte "Life by You" im Early Access erscheinen
                    und damit für die Öffentlichkeit spielbar werden sollen.
                    Doch den Release legte Paradox damals erneut nach hinten.
                    Nun ist klar: Der "Sims"-Konkurrent wird nie veröffentlicht.
                    "Als wir das Spiel aus einer breiteren Perspektive
                    betrachteten, wurde uns klar, dass der Weg bis zur
                    Veröffentlichung viel zu lang und ungewiss war", schreibt
                    Lilja im Paradox-Forum.
                  </p>
                  <p>
                    "Das ist natürlich hart und enttäuschend für alle, die ihre
                    Zeit und ihren Enthusiasmus in dieses Projekt gesteckt
                    haben, vor allem, wenn unsere Entscheidung so spät kommt."
                    Für die Entwicklung von "Life by You" hatte Paradox mit Rod
                    Humble einen früheren Entwickler von "The Sims" geschnappt.
                    Humble war zudem als CEO von "Second Life"-Entwickler Linden
                    Lab tätig.
                  </p>
                </div>
                <div className="chapterVideo">
